    ...
    for(int k = 0; k < d.np_tot[KDIR] ; k++) {
        for(int j = 0; j < d.np_tot[JDIR] ; j++) {
            for(int i = 0; i < d.np_tot[IDIR] ; i++) {
                ...
                d.dustVc[0](RHO,k,j,i) *= exp(-0.00339275*cos(Kx*x+Kb*1*z)+0.00332234*sin(Kx*x+Kb*1*z));
                d.dustVc[0](RHO,k,j,i) *= exp(0.00612245*cos(Kx*x+Kb*2*z)-0.00383803*sin(Kx*x+Kb*2*z));

                d.dustVc[0](VX1,k,j,i) = psi*cs*sin(Kb*z);
                d.dustVc[0](VX1,k,j,i) += 0.00010000*cos(Kx*x+Kb*1*z)-0.00010000*sin(Kx*x+Kb*1*z);
                d.dustVc[0](VX1,k,j,i) += 0.00010000*cos(Kx*x+Kb*2*z)-0.00010000*sin(Kx*x+Kb*2*z);

                d.dustVc[0](VX2,k,j,i) = shear*x;
                d.dustVc[0](VX2,k,j,i) += -0.00007479*cos(Kx*x+Kb*1*z)-0.00004725*sin(Kx*x+Kb*1*z);
                d.dustVc[0](VX2,k,j,i) += -0.00020537*cos(Kx*x+Kb*2*z)-0.00002485*sin(Kx*x+Kb*2*z);

                d.dustVc[0](VX3,k,j,i) = 0.0;
                d.dustVc[0](VX3,k,j,i) += -0.00004690*cos(Kx*x+Kb*1*z)+0.00005108*sin(Kx*x+Kb*1*z);
                d.dustVc[0](VX2,k,j,i) += 0.00018143*cos(Kx*x+Kb*2*z)-0.00006739*sin(Kx*x+Kb*2*z);
