    ...
    for(int k = 0; k < d.np_tot[KDIR] ; k++) {
        for(int j = 0; j < d.np_tot[JDIR] ; j++) {
            for(int i = 0; i < d.np_tot[IDIR] ; i++) {
                ...
                d.dustVc[1](VX1,k,j,i) = psi*cs*sin(Kb*z);
                d.dustVc[1](VX2,k,j,i) = shear*x;
                d.dustVc[1](VX3,k,j,i) = 0.0;
                d.dustVc[2](RHO,k,j,i) = chi[2];
                d.dustVc[2](VX1,k,j,i) = psi*cs*sin(Kb*z);
                d.dustVc[2](VX2,k,j,i) = shear*x;
                d.dustVc[2](VX3,k,j,i) = 0.0;
