...
real tauGlob;
real pi=3.14;
real max_ug = 0.8285876669;
real max_vg = 0.4232139129;
real max_ud = 0.8322097529;
real max_vd = 0.42135858;
    ...
    for(int k = 0; k < d.np_tot[KDIR] ; k++) {
        for(int j = 0; j < d.np_tot[JDIR] ; j++) {
            for(int i = 0; i < d.np_tot[IDIR] ; i++) {
                ...
                d.Vc(VX1,k,j,i) = 0.8285876669*z+2e-3*(idfx::randm()-0.5);
                //d.Vc(VX1,k,j,i) += 1.*psi*z*omega;
                d.Vc(VX2,k,j,i) = 0.00051703697*z;
                ...
                d.dustVc[0](VX1,k,j,i) = 0.83218604356697*z+2e-3*(idfx::randm()-0.5);
                d.dustVc[0](VX2,k,j,i) = -0.00258518489*z;
