...
real tauGlob;
real pi=3.14;
real max_ug = 4.14293833454248;
real max_vg = 2.116069564691353;
real max_ud = 4.161048764594287;
real max_vd = 2.106792919007976;
    ...
    for(int k = 0; k < d.np_tot[KDIR] ; k++) {
        for(int j = 0; j < d.np_tot[JDIR] ; j++) {
            for(int i = 0; i < d.np_tot[IDIR] ; i++) {
                ...
                d.Vc(VX1,k,j,i) = 4.142938*z+2e-3*(idfx::randm()-0.5);
                //d.Vc(VX1,k,j,i) += 1.*psi*z*omega;
                d.Vc(VX2,k,j,i) = 0.002585*z;
                ...
                d.dustVc[0](VX1,k,j,i) = 4.1609302*z+2e-3*(idfx::randm()-0.5);
                d.dustVc[0](VX2,k,j,i) = -0.0129259*z;
